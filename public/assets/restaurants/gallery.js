...
// Cargar fotos del restaurante
async function loadPhotos() {

    try {
        const restaurantId = document.getElementById('galleryModal').dataset.restauranteId;

        const response = await fetch(`/api/photos/restaurant/${restaurantId}`);
