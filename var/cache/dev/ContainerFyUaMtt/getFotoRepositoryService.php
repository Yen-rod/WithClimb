 ...
 */
class getFotoRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FotoRepository.php';

        return $container->privates['App\\Repository\\FotoRepository'] = new \App\Repository\FotoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
