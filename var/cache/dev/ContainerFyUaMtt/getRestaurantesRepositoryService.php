 ...
 */
class getRestaurantesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RestaurantesRepository' shared autowired service.
     *
     * @return \App\Repository\RestaurantesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RestaurantesRepository.php';

        return $container->privates['App\\Repository\\RestaurantesRepository'] = new \App\Repository\RestaurantesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
