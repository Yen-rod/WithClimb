 ...
 */
class getBloquesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BloquesRepository' shared autowired service.
     *
     * @return \App\Repository\BloquesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BloquesRepository.php';

        return $container->privates['App\\Repository\\BloquesRepository'] = new \App\Repository\BloquesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
