 ...
 */
class getViasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ViasRepository' shared autowired service.
     *
     * @return \App\Repository\ViasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ViasRepository.php';

        return $container->privates['App\\Repository\\ViasRepository'] = new \App\Repository\ViasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
