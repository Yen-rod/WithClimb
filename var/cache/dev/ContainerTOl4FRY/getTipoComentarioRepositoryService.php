 ...
 */
class getTipoComentarioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoComentarioRepository' shared autowired service.
     *
     * @return \App\Repository\TipoComentarioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoComentarioRepository.php';

        return $container->privates['App\\Repository\\TipoComentarioRepository'] = new \App\Repository\TipoComentarioRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
