 ...
 */
class getTipoFotoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoFotoRepository' shared autowired service.
     *
     * @return \App\Repository\TipoFotoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoFotoRepository.php';

        return $container->privates['App\\Repository\\TipoFotoRepository'] = new \App\Repository\TipoFotoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
