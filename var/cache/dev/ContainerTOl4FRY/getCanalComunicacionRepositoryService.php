 ...
 */
class getCanalComunicacionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CanalComunicacionRepository' shared autowired service.
     *
     * @return \App\Repository\CanalComunicacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CanalComunicacionRepository.php';

        return $container->privates['App\\Repository\\CanalComunicacionRepository'] = new \App\Repository\CanalComunicacionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
